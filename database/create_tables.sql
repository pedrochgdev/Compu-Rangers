...
CREATE TABLE USUARIO (
    ...
    rol VARCHAR(20) CHARACTER SET utf8mb4 NOT NULL COMMENT 'ROL DEL USUARIO',
...
CREATE TABLE MARCA (
    id INT AUTO_INCREMENT NOT NULL,
    nmbre VARCHAR(100) CHARACTER SET utf8mb4 NOT NULL COMMENT 'NOMBRE DE LA MARCA',
    PRIMARY KEY (ID)
) ENGINE=InnoDB;
...
CREATE TABLE ORDEN_DE_VENTA (
    id INT AUTO_INCREMENT NOT NULL,
    estado CHAR(1) NOT NULL COMMENT 'ESTADO DE LA ORDEN DE VENTA',
    ...
    CONSTRAINT ORDVEN_usuario_FK FOREIGN KEY (usuario_id) REFERENCES USUARIO (id)
) ENGINE=InnoDB;
...
CREATE TABLE DOCUMENTO_DE_VENTAS (
    ...
    total_pendiente DECIMAL(10,2) NOT NULL COMMENT 'TOTAL PENDIENTE DE LA VENTA',
    orden_de_venta_id INT NOT NULL,
    PRIMARY KEY (numero),
...
CREATE TABLE LOTE (
    ...
    estado CHAR(1) NOT NULL COMMENT 'ESTADO DEL LOTE',
...
CREATE TABLE INVENTARIO (
    ...
    cantidad_reservada INT NOT NULL COMMENT 'CANTIDAD RESERVADA DEL INVENTARIO',
    lote_id INT NOT NULL,
    producto_id INT NOT NULL,
...
CREATE TABLE IMPUESTO (
    ...
    tipo CHAR(1) NOT NULL COMMENT 'TIPO DEL IMPUESTO',
    PRIMARY KEY (id)
) ENGINE=InnoDB;
...
CREATE TABLE IMPUESTO_PERIODO (
    ...
    estado CHAR(1) NOT NULL COMMENT 'ESTADO DEL IMPUESTO EN EL PERIODO',
...
CREATE TABLE MONEDA_PERIODO (
    ...
    periodo_id INT NOT NULL,
    tipoCambio CHAR(1) NOT NULL COMMENT 'TIPO DE CAMBIO',
    estado CHAR(1) COMMENT 'ESTADO DEL TIPO DE CAMBIO POR PERIODO',
...
CREATE TABLE METODO_DE_PAGO (
    ...
    estado CHAR(1) NOT NULL COMMENT 'ESTADO DEL METODO DE PAGO',
    PRIMARY KEY (id)
) ENGINE=InnoDB;
...
CREATE TABLE PAGO (
    ...
    estado CHAR(1) NOT NULL COMMENT 'ESTADO EN EL QUE SE ENCUENTRA EL PAGO',
    ...
    CONSTRAINT pago_TIPCAMPER_FK FOREIGN KEY (moneda_periodo_moneda_id, moneda_periodo_periodo_id) 
